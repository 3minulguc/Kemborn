...
const DeliveryPage = () => {
  ...
  useEffect(() => {
    fetch(`${API_URL}/api/settings`)
      .then(res => res.json())
      .then(data => {
        setPolicy(data.delivery_return_policy || '<p>Teslimat ve iade politikası henüz eklenmedi.</p>');
      })
      .catch(err => console.error("Teslimat bilgisi yüklenirken hata oluştu:", err))
      .finally(() => setLoading(false));
  }, []);

  return (
    <main className="pb-20">
      <PageHeader title="Teslimat ve İade" />
