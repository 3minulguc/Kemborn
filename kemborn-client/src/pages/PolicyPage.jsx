...
const PolicyPage = () => {
  ...
  useEffect(() => {
    fetch(`${API_URL}/api/settings`)
      .then(res => res.json())
      .then(data => {
        setPolicy(data.privacy_policy || '<p>Gizlilik politikası henüz eklenmedi.</p>');
      })
      .catch(err => console.error("Gizlilik politikası yüklenirken hata oluştu:", err))
  ...
  return (
    <main className="pb-20">
      ...
      <div className="max-w-4xl mx-auto px-6 mt-12 text-zinc-600 leading-8">
        {loading ? (
          ...
          <div 
            className="w-full break-words text-zinc-600 leading-relaxed text-base space-y-4
